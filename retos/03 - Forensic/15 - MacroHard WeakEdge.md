...
## Solución
```bash
┌──(kali㉿kali)-[~/hacking/macrohard]
└─$ wget 'https://mercury.picoctf.net/static/9a7436948cc502e9cacf5bc84d2cccb5/Forensics is fun.pptm'
--2023-03-29 23:44:15--  https://mercury.picoctf.net/static/9a7436948cc502e9cacf5bc84d2cccb5/Forensics%20is%20fun.pptm
...
Forensics is fun.ppt 100%[====================>]  97.75K  --.-KB/s    en 0.1s    

2023-03-29 23:44:21 (666 KB/s) - «Forensics is fun.pptm» guardado [100093/100093]
...
└─$ ls -la       
total 104
drwxrwx--- 1 root vboxsf      0 mar 29 23:44  .
drwxrwx--- 1 root vboxsf   4096 mar 29 23:43  ..
...
└─$ code . 
```
![[Pasted image 20230329235105.png]]
```bash
┌──(kali㉿kali)-[~/hacking/macrohard]
